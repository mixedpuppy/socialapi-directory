...
var manifests = {
  ...
  "mixi": {
    ...
    "name": "mixi",
    "author": "mixi, Inc.",
    "description": "好きなWebサイトを見ながらmixiのチェックもできる便利なツールです。友人がつけてくれたイイネやコメントを通知するので、見落とさずにすぐにお返事ができます。また友人が今何をしているかをいつでも確認できます。",
  ...
  "goal": {
    "name": "GOAL",
    "iconURL": "http://goal.com/favicon.ico",
    "origin": "http://m.goal.com",
    "statusURL": "http://m.goal.com",
    "sidebarURL": "http://m.goal.com",
    "description": "Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. "
  }
};
...
for (var name in manifests) {
  manifests[name].key = name;
  view.data.push(manifests[name]);
}